...
import { ShieldCheck, Database, Globe, Stethoscope, Hammer, Zap, Activity, GraduationCap, Lock, CheckCircle2, ArrowRight, MapPin, Users } from "lucide-react";
...
export const metadata: Metadata = {
    title: "Annuaire des praticiens équins en France (ostéo, dentiste, maréchal) | Equivio",
    ...
    alternates: {
        canonical: "https://equivio.fr/annuaire",
    },
};
            ...
            <main className="flex-grow pb-24 lg:pb-0">
                <section className="pt-12 pb-10 lg:pt-20 lg:pb-16 px-6 bg-gradient-to-b from-white via-white to-neutral-offwhite relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
                        ...
                        <div id="search-section" className="pt-6 reveal [animation-delay:200ms] scroll-mt-24">
                            <SearchBar />
                        </div>
                    </div>
                </section>
                ...
                <section className="py-14 lg:py-20 bg-white reveal [animation-delay:200ms]">
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                { icon: Database, title: "Présence vérifiée", desc: "Nous validons que le praticien intervient régulièrement dans votre secteur.", gradient: "from-primary to-primary-soft" },
                                { icon: Globe, title: "Sans avis clients", desc: "La réputation ne s'achète pas. Seule la réalité du travail compte.", gradient: "from-leather to-leather-light" },
                                { icon: ShieldCheck, title: "Expertise certifiée", desc: "Diplômes contrôlés et statut professionnel validé.", gradient: "from-primary-soft to-primary" }
                            ].map((item, idx) => (
                                <div
                                    key={idx}
